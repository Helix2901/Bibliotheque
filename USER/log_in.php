  ...
  <body>
    ...
    <div class="wrapper">
      <form method="post">
        ...
        <div class="input-box">
          <input type="password" placeholder="Mot de passe" name="nbu" required />
        </div>
      ...
      <?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $requete = "SELECT * FROM Utilisateur WHERE AdresseMail = ? AND NbUsager = ?";
            $statement = $connexion->prepare($requete);
            $statement->bind_param("is", $pseudo, $mot_de_passe);
            $statement->execute();
            ...
            if ($resultat->num_rows > 0) {
                ...
                $_SESSION['num_id'] = $row['NbUsager'];
                $_SESSION['user_name'] = $row['AdresseMail'];
